      ...
      <div className="card-hover relative overflow-hidden">
        ...
        <div className="relative aspect-square bg-primary-50 overflow-hidden">
          ...
          <div className="absolute top-2 right-2 flex flex-col gap-1">
            ...
            {badge && (
              <span className="badge-offer text-[10px]">{badge}</span>
            )}
            {discountPct && (
          ...
          <button
            ...
            className="absolute top-2 rtl:left-2 ltr:left-2 p-1.5 rounded-full bg-white/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity"
          >
